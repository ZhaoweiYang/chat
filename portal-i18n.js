...
const portalI18n = {
  zh: {
    ...
    lbl_preview: "预览链接（截图或演示）", ph_preview: "https://...",
    ...
    btn_submit: "提交审核",
    err_name: "请输入模板名称。", err_desc: "请输入描述。", err_platform: "请至少选择一个平台。",
    submit_ok: "模板已提交审核！",
    // My templates
  ...
  en: {
    ...
    lbl_preview: "Preview URL (screenshot or demo link)", ph_preview: "https://...",
    ...
    err_name: "Please enter a template name.", err_desc: "Please enter a description.", err_platform: "Please select at least one platform.",
  ...
  fr: {
    ...
    lbl_preview: "URL de prévisualisation", ph_preview: "https://...",
    ...
    err_name: "Veuillez entrer un nom.", err_desc: "Veuillez entrer une description.", err_platform: "Veuillez sélectionner au moins une plateforme.",
  ...
  ru: {
    ...
    lbl_preview: "URL превью", ph_preview: "https://...",
    ...
    err_name: "Введите название шаблона.", err_desc: "Введите описание.", err_platform: "Выберите хотя бы одну платформу.",
  ...
  pt: {
    ...
    lbl_preview: "URL de prévia", ph_preview: "https://...",
    ...
    err_name: "Digite o nome do modelo.", err_desc: "Digite uma descrição.", err_platform: "Selecione pelo menos uma plataforma.",
  ...
  es: {
    ...
    lbl_preview: "URL de vista previa", ph_preview: "https://...",
    ...
    err_name: "Ingrese el nombre de la plantilla.", err_desc: "Ingrese una descripción.", err_platform: "Seleccione al menos una plataforma.",
