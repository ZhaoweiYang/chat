...
const portalI18n = {
  zh: {
    ...
    status_approved: "已通过", status_published: "已上架", status_rejected: "已拒绝", status_pending: "审核中",
    btn_delete: "删除", btn_publish: "上架", btn_unpublish: "下架", free: "免费",
    // Admin
    nav_dashboard: "仪表盘", nav_pending: "待审核", nav_all_tpl: "所有模板", nav_submit: "提交模板", nav_my_tpl: "我的模板", nav_usdt: "USDT设置",
    admin_title: "管理平台", admin_dash: "管理后台",
    admin_pass_label: "管理员密码", admin_pass_ph: "输入密码",
    wrong_pass: "密码错误。",
    stat_pending: "待审核", stat_approved: "已通过", stat_published: "已上架", stat_rejected: "已拒绝", stat_devs: "开发者",
    filter_published: "已上架",
  ...
  en: {
    ...
    status_approved: "Approved", status_published: "Published", status_rejected: "Rejected", status_pending: "Pending Review",
    btn_delete: "Delete", btn_publish: "Publish", btn_unpublish: "Unpublish", free: "Free",
    nav_dashboard: "Dashboard", nav_pending: "Pending Reviews", nav_all_tpl: "All Templates", nav_submit: "Submit Template", nav_my_tpl: "My Templates", nav_usdt: "USDT Settings",
    admin_title: "Admin Portal", admin_dash: "Admin Dashboard",
    admin_pass_label: "Admin Password", admin_pass_ph: "Enter password",
    wrong_pass: "Wrong password.",
    stat_pending: "Pending", stat_approved: "Approved", stat_published: "Published", stat_rejected: "Rejected", stat_devs: "Developers",
  ...
  fr: {
    ...
    status_approved: "Approuvé", status_published: "Publié", status_rejected: "Rejeté", status_pending: "En attente",
    btn_delete: "Supprimer", btn_publish: "Publier", btn_unpublish: "Dépublier", free: "Gratuit",
    nav_dashboard: "Tableau de bord", nav_pending: "En attente", nav_all_tpl: "Tous les modèles", nav_submit: "Soumettre", nav_my_tpl: "Mes modèles", nav_usdt: "Paramètres USDT",
    ...
    stat_pending: "En attente", stat_approved: "Approuvé", stat_published: "Publié", stat_rejected: "Rejeté", stat_devs: "Développeurs",
  ...
  ru: {
    ...
    status_approved: "Одобрен", status_published: "Опубликован", status_rejected: "Отклонён", status_pending: "На проверке",
    btn_delete: "Удалить", btn_publish: "Опубликовать", btn_unpublish: "Снять", free: "Бесплатно",
    nav_dashboard: "Панель", nav_pending: "На проверке", nav_all_tpl: "Все шаблоны", nav_submit: "Отправить", nav_my_tpl: "Мои шаблоны", nav_usdt: "Настройки USDT",
    ...
    stat_pending: "На проверке", stat_approved: "Одобрено", stat_published: "Опубликовано", stat_rejected: "Отклонено", stat_devs: "Разработчики",
  ...
  pt: {
    ...
    status_approved: "Aprovado", status_published: "Publicado", status_rejected: "Rejeitado", status_pending: "Em análise",
    btn_delete: "Excluir", btn_publish: "Publicar", btn_unpublish: "Despublicar", free: "Grátis",
    nav_dashboard: "Painel", nav_pending: "Pendentes", nav_all_tpl: "Todos os modelos", nav_submit: "Enviar", nav_my_tpl: "Meus modelos", nav_usdt: "Config. USDT",
    ...
    stat_pending: "Pendente", stat_approved: "Aprovado", stat_published: "Publicado", stat_rejected: "Rejeitado", stat_devs: "Desenvolvedores",
  ...
  es: {
    ...
    status_approved: "Aprobada", status_published: "Publicada", status_rejected: "Rechazada", status_pending: "En revisión",
    btn_delete: "Eliminar", btn_publish: "Publicar", btn_unpublish: "Despublicar", free: "Gratis",
    nav_dashboard: "Panel", nav_pending: "Pendientes", nav_all_tpl: "Todas las plantillas", nav_submit: "Enviar", nav_my_tpl: "Mis plantillas", nav_usdt: "Config. USDT",
    ...
    stat_pending: "Pendiente", stat_approved: "Aprobado", stat_published: "Publicado", stat_rejected: "Rechazado", stat_devs: "Desarrolladores",
    filter_published: "Publicado",
