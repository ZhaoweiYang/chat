...
const portalI18n = {
  zh: {
    ...
    contact_title: "联系信息", lbl_website: "官网地址", lbl_contact: "联系方式", ph_contact: "邮箱、Telegram等", lbl_show_contact: "在模板市场展示联系信息",
    saved: "已保存！",
    // Submit template
    submit_title: "提交新模板",
    ...
    btn_delete: "删除", btn_publish: "上架", btn_unpublish: "下架", btn_update: "更新", btn_history: "版本历史", free: "免费",
    update_title: "更新模板", update_note_label: "更新说明", update_note_ph: "请描述本次更新的内容...", btn_submit_update: "提交更新审核", update_ok: "已提交更新审核！",
    version_label: "版本", history_title: "版本历史", no_history: "暂无更新记录",
    // Admin
  ...
  en: {
    ...
    contact_title: "Contact Info", lbl_website: "Website", lbl_contact: "Contact", ph_contact: "Email, Telegram, etc.", lbl_show_contact: "Show contact info in template market",
    saved: "Saved!",
    ...
    btn_delete: "Delete", btn_publish: "Publish", btn_unpublish: "Unpublish", btn_update: "Update", btn_history: "History", free: "Free",
    update_title: "Update Template", update_note_label: "Update Notes", update_note_ph: "Describe what changed...", btn_submit_update: "Submit Update for Review", update_ok: "Update submitted for review!",
    version_label: "Version", history_title: "Version History", no_history: "No update history.",
  ...
  fr: {
    ...
    contact_title: "Coordonnées", lbl_website: "Site web", lbl_contact: "Contact", ph_contact: "Email, Telegram, etc.", lbl_show_contact: "Afficher les coordonnées dans le marché",
    saved: "Enregistré !",
    ...
    btn_delete: "Supprimer", btn_publish: "Publier", btn_unpublish: "Dépublier", btn_update: "Mettre à jour", btn_history: "Historique", free: "Gratuit",
    update_title: "Mettre à jour le modèle", update_note_label: "Notes de mise à jour", update_note_ph: "Décrivez les changements...", btn_submit_update: "Soumettre la mise à jour", update_ok: "Mise à jour soumise !",
    version_label: "Version", history_title: "Historique des versions", no_history: "Aucun historique.",
  ...
  ru: {
    ...
    contact_title: "Контактная информация", lbl_website: "Сайт", lbl_contact: "Контакт", ph_contact: "Email, Telegram и т.д.", lbl_show_contact: "Показывать контакты на маркетплейсе",
    saved: "Сохранено!",
    ...
    btn_delete: "Удалить", btn_publish: "Опубликовать", btn_unpublish: "Снять", btn_update: "Обновить", btn_history: "История", free: "Бесплатно",
    update_title: "Обновить шаблон", update_note_label: "Заметки", update_note_ph: "Опишите изменения...", btn_submit_update: "Отправить обновление", update_ok: "Обновление отправлено!",
    version_label: "Версия", history_title: "История версий", no_history: "Нет истории.",
  ...
  pt: {
    ...
    contact_title: "Informações de contato", lbl_website: "Site", lbl_contact: "Contato", ph_contact: "Email, Telegram, etc.", lbl_show_contact: "Exibir contato no mercado de modelos",
    saved: "Salvo!",
    ...
    btn_delete: "Excluir", btn_publish: "Publicar", btn_unpublish: "Despublicar", btn_update: "Atualizar", btn_history: "Histórico", free: "Grátis",
    update_title: "Atualizar modelo", update_note_label: "Notas", update_note_ph: "Descreva as mudanças...", btn_submit_update: "Enviar atualização", update_ok: "Atualização enviada!",
    version_label: "Versão", history_title: "Histórico de versões", no_history: "Sem histórico.",
  ...
  es: {
    ...
    contact_title: "Información de contacto", lbl_website: "Sitio web", lbl_contact: "Contacto", ph_contact: "Email, Telegram, etc.", lbl_show_contact: "Mostrar contacto en el mercado de plantillas",
    saved: "¡Guardado!",
    ...
    btn_delete: "Eliminar", btn_publish: "Publicar", btn_unpublish: "Despublicar", btn_update: "Actualizar", btn_history: "Historial", free: "Gratis",
    update_title: "Actualizar plantilla", update_note_label: "Notas", update_note_ph: "Describa los cambios...", btn_submit_update: "Enviar actualización", update_ok: "¡Actualización enviada!",
    version_label: "Versión", history_title: "Historial de versiones", no_history: "Sin historial.",
